function getdata() {
    ...
    // console.log(cannamthem1, "cannamthem1" )
    // console.log(cannamthem, "cannamthem" )
    // console.log(tennguoi, "tennguoi" )
    // console.log(phutdl, "phutdl" )
    // console.log(ngaydl, "ngaydl" )
    // console.log(thangdl, "thangdl" )
    // console.log(namdl, "namdl" )
    // console.log(giodl, "giodl" )
    // console.log(nam, "nam" )
    // console.log(ngay, "ngay" )
    // console.log(thang, "thang" )
    // console.log(gio, "gio" )
    // console.log(namxem, "namxem" )
    // console.log(thangxem, "thangxem" )
    // console.log(ngayxem, "ngayxem" )
    // console.log(gioxem, "gioxem" )
    // console.log(gioxemdl, "gioxemdl" )
...
function setup() {
    ...
    // console.log(ngay, "ngay");
    // console.log(gio, "gio");
    // console.log(cannamxem, "cannamxem");
    // console.log(chinamxem, "chinamxem");
    // console.log(canthangxem, "canthangxem");
    // console.log(chithangxem, "chithangxem");
    // console.log(canngayxem, "canngayxem");
    // console.log(chingayxem, "chingayxem");
    // console.log(cangioxem, "cangioxem");
    // console.log(chigioxem, "canngachigioxemyxem");
    // console.log(ngayxem, "ngayxem");
    // console.log(thangxem, "thangxem");
    // console.log(namxem, "namxem");
    if (namxem > nam - 1) {
        if (laso != 1) {
            var thunghiem;
            for (var i = 0; i < 1; i++) {
                thunghiem = bacot(cannam, chinam, thang, ngay, gio, cannamxem, chinamxem,
                    canthangxem, chithangxem, canngayxem, chingayxem,
